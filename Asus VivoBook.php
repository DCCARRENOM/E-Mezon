  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4350368_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      <h5>Precio : $1.199.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 34";
      ...
      <form action="Asus VivoBook.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Asus VivoBook 14 pulgadas'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1199900 WHERE Producto = 'Asus VivoBook 14 pulgadas'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Asus VivoBook 14 pulgadas', '1', '1199900')";
