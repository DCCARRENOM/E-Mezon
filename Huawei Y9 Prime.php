  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4229118_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Cámara posterior: 16MP+8MP+2MP
      Cámara frontal: 16MP
      Memoria interna: 128GB
      Núcleos del procesador: Octa Core
      Garantía del proveedor:	1 año</pre>
      <h5>Precio : $749.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 30";
      ...
      <form action="Huawei Y9 Prime.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Huawei Y9 Prime'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+749900 WHERE Producto = 'Huawei Y9 Prime'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Huawei Y9 Prime', '1', '749900')";
