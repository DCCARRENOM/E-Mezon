  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4183604_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Motorola G8 plus
      Sensor 48 MPX + Night Vision.
      Cámara frontal 25 MPX.
      Más de un día de batería + Cargador Turbo Power.
      Pantalla Max Vision 6.3"
      Marca:	Motorola
      ...
      <h5>Precio : $699.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 29";
      ...
      <form action="Motorola G8 plus.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Motorola G8 plus'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+699900 WHERE Producto = 'Motorola G8 plus'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Motorola G8 plus', '1', '699900')";
