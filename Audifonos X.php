  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4133626_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Audífonos Bluetooth Xiaomi Basic
      Marca: Xiaomi
      Frecuencia: 20- 20k Hz
      Garantía del proveedor:	3 Meses</pre>
      <h5>Precio : $90.000</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 44";
      ...
      <form action="Audifonos X.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Audífonos Bluetooth Xiaomi Basic'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+90000 WHERE Producto = 'Audífonos Bluetooth Xiaomi Basic'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Audífonos Bluetooth Xiaomi Basic', '1', '90000')";
