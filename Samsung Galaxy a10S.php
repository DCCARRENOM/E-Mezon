  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/3652059_1?q=i?wid=800&hei=800&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      <h5>Precio : $719.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 25";
      ...
      <form action="Samsung Galaxy a10S.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Samsung Galaxy a10S'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+719900 WHERE Producto = 'Samsung Galaxy a10S'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Samsung Galaxy a10S', '1', '719900')";
