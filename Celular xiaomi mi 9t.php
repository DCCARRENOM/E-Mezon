  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4975267_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      <form action="Celular xiaomi mi 9t.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Celular xiaomi mi 9t'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1299900 WHERE Producto = 'Celular xiaomi mi 9t'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Celular xiaomi mi 9t', '1', '1299900')";
