  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/3346545_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Mouse Inalámbrico Vortex Nano KMW-355BK
      Modelo KMW-355BK.
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 41";
      ...
      <form action="Mouse Vortex.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Mouse Inalámbrico Vortex Nano KMW-355BK'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+69900 WHERE Producto = 'Mouse Inalámbrico Vortex Nano KMW-355BK'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Mouse Inalámbrico Vortex Nano KMW-355BK', '1', '69900')";
