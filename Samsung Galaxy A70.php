  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/3905281_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 26";
      ...
      <form action="Samsung Galaxy A70.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Samsung Galaxy A70'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1599900 WHERE Producto = 'Samsung Galaxy A70'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Samsung Galaxy A70', '1', '1599900')";
