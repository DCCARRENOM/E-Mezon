  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/3099980_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      <form action="MacBook Air.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'MacBook Air 13.3 pulgadas'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+2699900 WHERE Producto = 'MacBook Air 13.3 pulgadas'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('MacBook Air 13.3 pulgadas', '1', '2699900')";
