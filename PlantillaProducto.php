...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    ...
    <div class="w3-right">
      ...
      <a class="fa fa-user-circle-o " style="color: red;" href="file:///C:/Users/Sebastian%20Wilches/Desktop/Universidad/4%20semestre/Programacion%20avanzada/2%20Corte/E-Mezon2/Login.html" ></a>
    </div>
  </header>
  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://media.playstation.com/is/image/SCEA/playstation-4-slim-vertical-product-shot-01-us-07sep16?$native_t$" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Modelo:	CUH-2215B
      Hecho en:	China
      Incluye:	Consola PlayStation®4 (1 TB negro azabache)
      Control DualShock®4 para PlayStation 4
      Cable HDMI
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 2";
      ...
      <form action="PlantillaProducto.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Playstation 4'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1000000 WHERE Producto = 'Playstation 4'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Playstation 4', '1', '1000000')";
