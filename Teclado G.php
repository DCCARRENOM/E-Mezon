  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4170560_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 43";
      ...
      <form action="Teclado G.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Teclado Genius'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+35900 WHERE Producto = 'Teclado Genius'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Teclado Genius', '1', '35900')";
