  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4153788_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Teclado Numérico Inalámbrico Negro
      Marca: Klipxtreme
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 45";
      ...
      <form action="Teclado Numérico.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Teclado Numérico Inalámbrico Negro'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+30900 WHERE Producto = 'Teclado Numérico Inalámbrico Negro'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Teclado Numérico Inalámbrico Negro', '1', '30900')";
