  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/3875928_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Cámara posterior: 40MP
      Cámara frontal: Sobre 16MP
      Memoria interna: 256GB
      Núcleos del procesador: Octa Core
      Garantía del proveedor:	1 año</pre>
      <h5>Precio : $1.699.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 27";
      ...
      <form action="Huawei P30.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Huawei P30'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1699900 WHERE Producto = 'Huawei P30'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Huawei P30', '1', '1699900')";
