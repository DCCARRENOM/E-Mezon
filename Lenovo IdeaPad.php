  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4300561_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      Lenovo IdeaPad S340 14 pulgadas
      Procesador: Intel Core i3
      Modelo tarjeta de video: Intel HD Graphics 6000
      Tamaño de la pantalla: 14 pulgadas
      Disco duro estado sólido: 256GB
      Núcleos del procesador: Dual Core
      Garantía del proveedor:	1 año</pre>
      <h5>Precio : $1.599.900</h5>

      <h5>Productos disponibles:</h5>
      <?php
      include("AbrirConexion.php");
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 38";
      ...
      <form action="Lenovo IdeaPad.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Lenovo IdeaPad S340 14 pulgadas'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1599900 WHERE Producto = 'Lenovo IdeaPad S340 14 pulgadas'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Lenovo IdeaPad S340 14 pulgadas', '1', '1599900')";
