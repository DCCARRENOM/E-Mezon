  ...
  <div class="w3-row w3-grayscale w3-padding-64">
    <div class="w3-half">
        <div class="w3-container">
            <img src="https://falabella.scene7.com/is/image/FalabellaCO/4226767_1?wid=1500&hei=1500&qlt=70" style="width: 100%; height:100% ;">
    ...
    <div class="w3-half">
      ...
      $sql="SELECT Stock FROM Productos WHERE IDProducto = 28";
      ...
      <form action="Xiaomi Redmi Note 8 Pro.php" method="POST">
        ...
        $sql2="SELECT Cantidad FROM transacciones WHERE Producto = 'Xiaomi Redmi Note 8 Pro'";
        $result2 = mysqli_query($conexion,$sql2);
        if( mysqli_num_rows($result2) != 0){
          $sql3= "UPDATE transacciones SET Cantidad = Cantidad +1, valor=valor+1299900 WHERE Producto = 'Xiaomi Redmi Note 8 Pro'";
          ...
          if(!$result){
            ...
            $sql1= "INSERT INTO transacciones VALUES ('Xiaomi Redmi Note 8 Pro', '1', '1299900')";
